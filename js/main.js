$(document).ready(function () {
    ...
    $('#form_legumes_commander').click(function () {
        ...
        $('html, body').animate({scrollTop: $("#form_contact_legumes").offset().top - 150}, 1500);
    });
    ...
    $('main .sections.galleries .content .textes .gallery .images').each(function () {
...
Array.from(query('.myInputs input')).map(
    item => item.addEventListener('input', function () {
